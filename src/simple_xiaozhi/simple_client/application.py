...
class Application:
    ...
    def __init__(self):
        ...
        try:
            aec_enabled_cfg = bool(self.config.config.AEC_OPTIONS.ENABLED)
        except Exception:
