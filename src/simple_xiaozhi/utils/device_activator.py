...
from simple_xiaozhi.utils.common_utils import handle_verification_code
...
class DeviceActivator:
    ...
    async def process_activation(self, activation_data: dict) -> bool:
        ...
        try:
            ...
            try:
                # 在非阻塞的线程中播放语音
                from simple_xiaozhi.utils.common_utils import play_audio_nonblocking
                ...
                for attempt in range(max_retries):
                    try:
                        ...
                        if attempt > 0 and code:
                            try:
                                from simple_xiaozhi.utils.common_utils import (
