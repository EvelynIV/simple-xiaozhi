...
from simple_xiaozhi.constants.system import SystemConstants
...
class McpServer:
    ...
    def add_common_tools(self):
        ...
        # 添加桌面截图工具
        from simple_xiaozhi.mcp.tools.screenshot import take_screenshot
        ...
        # 添加八字命理工具
        from simple_xiaozhi.mcp.tools.bazi import get_bazi_manager
