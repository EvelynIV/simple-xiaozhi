...
from simple_xiaozhi.constants.constants import DeviceState, ListeningMode
from simple_xiaozhi.plugins.calendar import CalendarPlugin
from simple_xiaozhi.plugins.iot import IoTPlugin
from simple_xiaozhi.plugins.manager import PluginManager
from simple_xiaozhi.plugins.mcp import McpPlugin
from simple_xiaozhi.plugins.shortcuts import ShortcutsPlugin
from simple_xiaozhi.plugins.ui import UIPlugin
from simple_xiaozhi.plugins.wake_word import WakeWordPlugin
from simple_xiaozhi.protocols.mqtt_protocol import MqttProtocol
from simple_xiaozhi.protocols.websocket_protocol import WebsocketProtocol
...
class Application:
    ...
    async def run(self, *, protocol: str = "websocket", mode: str = "gui") -> int:
        ...
        try:
            ...
            from simple_xiaozhi.plugins.audio import AudioPlugin
    ...
    # -------------------------
    async def start_auto_conversation(self, *, force_realtime: bool = False) -> None:
        try:
            ok = await self.connect_protocol()
            if not ok:
                return
