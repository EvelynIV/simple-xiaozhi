...
from simple_xiaozhi.constants.system import InitializationStage
from simple_xiaozhi.core.ota import Ota
from simple_xiaozhi.utils.config_manager import ConfigManager
from simple_xiaozhi.utils.device_fingerprint import DeviceFingerprint
...
class SystemInitializer:
    ...
    async def stage_1_device_fingerprint(self):
        ...
        # 验证efuse.json文件是否完整
        efuse_file = Path("model-bin/efuse.json")
    ...
    async def _run_gui_activation(self) -> Dict:
        ...
        """
        try:
            from simple_xiaozhi.views.activation.activation_window import ActivationWindow
    ...
    async def _run_cli_activation(self) -> Dict:
        ...
        """
        try:
            from simple_xiaozhi.views.activation.cli_activation import CLIActivation
